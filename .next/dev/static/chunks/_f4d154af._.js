        ...
        "RootPage.useEffect": ()=>{
            ...
            if (user) {
                ...
                const checkStorefront = {
                    "RootPage.useEffect.checkStorefront": async ()=>{
                        try {
                            const host = ("TURBOPACK compile-time truthy", 1) ? window.location.host : "TURBOPACK unreachable";
                            const response = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2d$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_BASE_URL"]}/public/storefront`, {
                                headers: {
                                    'x-shop-domain': host
                                }
                            });
                ...
                }["RootPage.useEffect.checkStorefront"];
...
_s(RootPage, "ECuTCuyBzuCScSXDCsKsZ4/7zwU=", false, function() {
    return [
