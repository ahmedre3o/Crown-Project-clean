        ...
        if (user) {
            ...
            const checkStorefront = async ()=>{
                try {
                    ...
                    const response = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2d$config$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["API_BASE_URL"]}/public/storefront`, {
                        headers: {
                            'x-shop-domain': host
                        }
                    });
