...
function OnlineOrdersPageContent() {
  ...
  return (
    <div className="min-h-screen flex" dir={direction}>
      <Sidebar />
      <main
        className="flex-1 p-6 pt-20 md:p-8 md:pt-8 overflow-y-auto overflow-x-auto min-w-0"
        style={{ WebkitOverflowScrolling: 'touch', maxHeight: '100dvh' } as React.CSSProperties}
      >
          ...
          {loading ? (
            ...
            <div className="overflow-x-auto">
              ...
              {orders.map((order) => (
                ...
                >
                  <div
                    className="flex flex-wrap items-center justify-between gap-4 px-5 py-4 cursor-pointer min-w-0"
                  ...
                  >
                    <div className="flex flex-wrap items-center gap-3 min-w-0">
                      ...
                      <div className="min-w-0">
                        <div className="text-slate-100 font-semibold truncate">{order.customer_name}</div>
                        <div className="text-xs text-slate-400 truncate">{order.phone}</div>
                      </div>
