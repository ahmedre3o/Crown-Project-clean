...
const INVENTORY_SOUND_ROLES = new Set(['shop_owner', 'branch_manager', 'multi_branch_manager', 'warehouse', 'super_admin']);
...
import { formatNotificationDate, formatNotificationSummaryLine, getNotificationTitle } from '../lib/notifications';
...
export function NotificationsBell() {
  ...
  const summary = (n: Notification) => formatNotificationSummaryLine(n, language);
      ...
      <div className="relative">
        ...
        {open && (
          <>
            ...
            {isMobile ? (
              <div
                className={`fixed inset-x-0 bottom-0 z-50 rounded-t-2xl border border-cyan-500/30 bg-[#050812] shadow-[0_0_32px_rgba(34,211,238,0.35)] w-full max-h-[80vh] overflow-y-auto overflow-x-hidden ${
              ...
              >
                ...
                <div className="max-h-[70vh] overflow-y-auto overflow-x-hidden" style={{ WebkitOverflowScrolling: 'touch' } as React.CSSProperties}>
                  {loadError ? (
                    ...
                    notifications.map((n) => {
                      ...
                      >
                        <div className="flex flex-col gap-1 w-full">
                          ...
                          {summary(n) ? (
                            <div className="text-xs text-slate-400 mt-1 whitespace-normal break-words line-clamp-3 leading-relaxed">
                              {summary(n)}
                            </div>
                          ) : null}
