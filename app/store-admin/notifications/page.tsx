...
export default function NotificationsPage() {
  ...
  return (
    <div className="min-h-screen flex" dir={direction}>
      <Sidebar />
      <main className="flex-1 p-6 md:p-8 min-w-0 overflow-y-auto overflow-x-hidden" style={{ WebkitOverflowScrolling: 'touch' } as React.CSSProperties}>
          ...
          <div className="flex flex-wrap gap-3 mb-6">
            <div className="flex-1 min-w-[200px] relative">
              ...
              <input
                ...
                className="w-full h-11 ps-10 pe-4 rounded-xl border border-cyan-500/25 bg-black/30 text-slate-100 placeholder:text-slate-500"
              />
            </div>
                ...
                >
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      {summaryLine ? (
                        <div className="text-xs text-slate-500 mt-1.5 leading-relaxed whitespace-pre-wrap break-words">
                          {summaryLine}
                        </div>
                      ) : null}
